...
class Peer:
    ...
    def toListBlockFile(self, last, begin):
        for i in range(begin, last):
            file = open("A:\computer network course\Project1\Peer2\PEER3Dir/" + str(i) + ".pdf.chk", 'rb')
    ...
    def __getBootStrap(self):
        ...
        sepDir = os.path.join("A:\computer network course\Project1\Peer2/" + sepDir)
    ...
    def __performAfterCheckChunk(self):
        file = os.path.join("A:\computer network course\Project1\Peer2/" + self.merge_file_name)
        ...
        # p = pa/new
        os.chdir('A:\computer network course\Project1\Peer2\PEER3Dir')
