...
class Peer:
    ...
    def toListBlockFile(self, last, begin):
        for i in range(begin, last):
            file = open("A:\computer network course\Project1\Peer5\PEER6Dir/" + str(i) + ".pdf.chk", 'rb')
    ...
    def __getBootStrap(self):
        ...
        self.peer_socket.send(("1024").encode())
        ...
        sepDir = os.path.join("A:\computer network course\Project1\Peer5/" + sepDir)
    ...
    def __performAfterCheckChunk(self):
        file = os.path.join("A:\computer network course\Project1\Peer5/" + self.merge_file_name)
        if not path.exists(file):
            os.mkdir(file)
        read_buffer_size = 1024
        chunk_size = 1024 * 100
        p = Path.cwd()
        # p.chdir('/home/gourav/Desktop/Trimester 2/Computer networks/chunks2')
        # p = pa/new
        os.chdir('A:\computer network course\Project1\Peer5\PEER6Dir')
